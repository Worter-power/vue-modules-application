...
module.exports = {
    ...
    output: {
        ...
        filename: 'lib/'+process.env.VERSION+'/js/[name].min.js',
        chunkFilename: 'lib/'+process.env.VERSION+'/js/[name].min.js',
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({ 
            filename: '/lib/'+process.env.VERSION+'/css/[name].min.css',
            chunkFilename: '/lib/'+process.env.VERSION+'/css/[id].min.css',
        }),
        new VueLoaderPlugin(),
        // 输出资源清单
        new ManifestPlugin(),
