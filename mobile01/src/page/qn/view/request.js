...
export let getYearlist = (unitId) => {
    let result = new Promise((resolve, reject) => {
        request('get', '/api/base/years/no_auth', { unitId }).then((data) => {
...
// POST /upload/base64_convert_image base64转图片
export let convertImageBase64 = (params) => {
    return request('POST', '/api/storage/upload/base64_convert_image', params);
};